...
class Entry(VoteMixin, models.Model):
	string = models.CharField(max_length=12000)
	client = models.ForeignKey(Client, null=True, on_delete=models.CASCADE)
	parentThread = models.ForeignKey(Thread, null=True, on_delete=models.DO_NOTHING, related_name='pThread')
	childThread = models.ForeignKey(Thread, null=True, on_delete=models.DO_NOTHING, related_name='cThread')
...
class Topic(models.Model):
	...
	entriesComplete = models.BooleanField(default=False)
	teamA = models.OneToOneField(Team, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='teamA')
	teamB = models.OneToOneField(Team, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='teamB')
	entryA = models.OneToOneField(Entry, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='entryA')
	entryB = models.OneToOneField(Entry, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='entryB')
	voter1 = models.OneToOneField(Team, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='voter1')
	voter2 = models.OneToOneField(Team, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='voter2')
